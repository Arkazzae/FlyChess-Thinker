...
export const IconBrain = ({ size = 28 }: P) => (
  <svg width={size} height={size} viewBox="0 0 32 32" aria-hidden="true">
    <path d="M12.5 5.5c-2.3 0-4 1.6-4.3 3.6-2.1.4-3.7 2.2-3.7 4.4 0 1 .3 1.9.9 2.6-.6.8-.9 1.7-.9 2.7 0 2.1 1.4 3.9 3.4 4.4.4 2.3 2.4 4 4.7 4 1.2 0 2.4-.5 3.2-1.3V6.9c-.8-.9-2-1.4-3.3-1.4Z" fill="#c792ff" />
    <path d="M19.5 5.5c2.3 0 4 1.6 4.3 3.6 2.1.4 3.7 2.2 3.7 4.4 0 1-.3 1.9-.9 2.6.6.8.9 1.7.9 2.7 0 2.1-1.4 3.9-3.4 4.4-.4 2.3-2.4 4-4.7 4-1.2 0-2.4-.5-3.2-1.3V6.9c.8-.9 2-1.4 3.3-1.4Z" fill="#a66ef2" />
    <g stroke="#5b2aa0" strokeWidth="1.3" strokeLinecap="round" fill="none" opacity=".75">
      <path d="M9 13.5c1.5 0 2.6 1 2.6 2.5M8.5 19.5c1.7-.3 3 .6 3.5 2M20.5 10.5c-1.3.3-2 1.5-1.8 2.8M23 17c-1.5-.2-2.8.8-3 2.3" />
    </g>
    <circle cx="25.5" cy="6.5" r="2.2" fill="#8ff0ff" />
    <circle cx="25.5" cy="6.5" r="4" fill="#8ff0ff" opacity=".25" />
  </svg>
);
