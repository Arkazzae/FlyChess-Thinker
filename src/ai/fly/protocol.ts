...
export type FlyCommand =
  ...
  /** Swap in another trained model (e.g. fly-v4) on the same connectome. */
  | { type: "weights"; id: number; weights: ArrayBuffer };
...
export type FlyReply =
  ...
  | { type: "model"; id: number; backend: "webgpu" | "cpu"; adapter: string; roles: Uint8Array }
